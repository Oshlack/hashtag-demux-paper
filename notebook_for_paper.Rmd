...
HashSolo is a scanpy program. See the notebook for how we get these assignments
```{r}
seu1_c1$hashsolo_calls <- read.csv("~/singlecell/hashtag-demux-paper/data/adata/batch1_c1_hashsolo.csv")$Classification
seu1_c2$hashsolo_calls <- read.csv("~/singlecell/hashtag_project/data/adata/batch1_c2_hashsolo.csv")$Classification

seu2_c1$hashsolo_calls <- read.csv("~/singlecell/hashtag-demux-paper/data/adata/batch2_c1_hashsolo.csv")$Classification
seu2_c2$hashsolo_calls <- read.csv("~/singlecell/hashtag-demux-paper/data/adata/batch2_c2_hashsolo.csv")$Classification

seu3_c1$hashsolo_calls <- read.csv("~/singlecell/hashtag-demux-paper/data/adata/batch3_c1_hashsolo.csv")$Classification
seu3_c2$hashsolo_calls <- read.csv("~/singlecell/hashtag-demux-paper/data/adata/batch3_c2_hashsolo.csv")$Classification
```
...
```{r}
method_calls <- c("hashedDrops_calls", "hashedDrops_default_calls", "hashsolo_calls", "HTODemux_calls", "GMMDemux_calls",
...
```{r}
batch1_doublet_assignments <- data.frame("method" = c("hashedDrops", "hashedDrops (default)", "HashSolo", "HTODemux",
...
batch2_doublet_assignments <- data.frame("method" = c("hashedDrops", "hashedDrops (default)", "HashSolo", "HTODemux", 
                                                      "GMM-Demux", "deMULTIplex", "BFF_raw",
                                                      "BFF_cluster", "demuxmix"),
...
batch3_doublet_assignments <- data.frame("method" = c("hashedDrops", "hashedDrops (default)", "HashSolo", "HTODemux",
                                                      "GMM-Demux", "deMULTIplex", "BFF_raw",
                                                      "BFF_cluster", "demuxmix"),
...
```{r}
seu_lmo_c1$hashsolo_calls <- read.csv(here("data", "adata", "lmo_c1_hashsolo.csv"))$Classification
seu_lmo_c2$hashsolo_calls <- read.csv(here("data", "adata", "lmo_c2_hashsolo.csv"))$Classification
seu_lmo_c3$hashsolo_calls <- read.csv(here("data", "adata", "lmo_c3_hashsolo.csv"))$Classification
```
...
```{r}
doublet_assignments <- data.frame("method" = c("hashedDrops", "hashedDrops (default)", "HashSolo", "HTODemux",
                                                      "GMM-Demux", "deMULTIplex", "BFF_raw",
                                                      "BFF_cluster", "demuxmix"),
